...
public interface LiteralDescriptionBuilder<T extends LiteralDescription, B extends LiteralDescriptionBuilder<T, B>> {
    ...
    B withDataType(String dataType);

    B withDefaultUOM(OwsUOM defaultUOM);

    B withDefaultUOM(String defaultUOM);

    B withSupportedUOM(Iterable<OwsUOM> uoms);

    B withSupportedUOM(OwsUOM uom);

    B withSupportedUOM(String uom);

    B withSupportedUOM(String ref, String uom);
