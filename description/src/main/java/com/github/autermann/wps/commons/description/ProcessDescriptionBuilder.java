...
public interface ProcessDescriptionBuilder<T extends ProcessDescription, B extends ProcessDescriptionBuilder<T, B>>
    ...
    B withInput(ProcessInputDescriptionBuilder<?, ?> input);

    B withInput(Iterable<ProcessInputDescription> inputs);

    B withInput(ProcessInputDescription... inputs);

    B withOutput(ProcessOutputDescription output);

    B withOutput(ProcessOutputDescriptionBuilder<?, ?> output);

    B withOutput(Iterable<ProcessOutputDescription> outputs);

    B withOutput(ProcessOutputDescription... outputs);
